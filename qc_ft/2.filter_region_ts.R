...
id_clean_FD_clean_ts <- id_clean_FD[-which(id_clean_FD %in% c("AP078"))]
...
ts.final <- ts_no_NA_regions_noHipp
ts.final %>% dim
...
FD_df_after_all_exclusions <- FD_df_after_exclusions[id_clean_FD_clean_ts,] 
